...
<%@ page import="com.frditlabs.model.Lot" %>
<%@ page import="com.frditlabs.util.DateUtil" %>
...
<body>
	...
	<div class="bs-docs-section">
		...
		<form action="saveLot">
			...
			<s:textfield key="lot.dueDate" label="Fecha de Vencimiento" cssClass="form-control form-group"></s:textfield>
